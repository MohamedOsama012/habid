...
import 'package:habit_track/feature/Auth/presentation/ui/widget/custom_text.dart';
import 'package:habit_track/feature/Auth/presentation/ui/widget/googal_button.dart';
import 'package:habit_track/feature/Auth/presentation/ui/widget/password_field.dart';
import 'package:habit_track/feature/Auth/presentation/ui/widget/remmber_me.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocListener<UserCubit, AuthState>(
  ...
  Future<void> handleGoogleSignIn() async {
    try {
      final userCredential = context.read<UserCubit>();
